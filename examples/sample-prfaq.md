...
> **Funnel position:** Stage 3 (PR/FAQ Draft) — output of `/ccc:write-prfaq`
> **Next step:** Send to adversarial review via `/ccc:review` → see [sample-review-findings.md](sample-review-findings.md)
