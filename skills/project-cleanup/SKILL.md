...
Research notes, literature reviews, methodology decisions, session learnings -- these are Documents, not issues. They have no "done" state. Creating them as issues bloats the tracker and makes triage noisy. Use the Content Classification Matrix above.
